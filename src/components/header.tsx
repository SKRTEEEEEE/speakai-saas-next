    ...
    return (
        <nav className="container flex items-center justify-between px-8 py-4 mx-auto">
            <div className="flex lg:flex-1 ">
                <NavLink href="/">
                <span className="flex items-center gap-2 shrink-0"><GhostIcon className="hover:rotate-12 transform transition duration-200 ease-in-out"/>
            ...
            <div className="flex lg:justify-center gap-2 lg:gap-12 lg:items-center">
                ...
                <SignedIn>
                <Link href={"/#posts"}>Your Posts</Link></SignedIn>
            </div>
